...
compile_command="make -f b747cl.mk"
...
cp "$home/b747cl_grt_rtw/b747cl.c"  "$home/b747cl.c"
...
do
	...
	for filename in $(find /$full_path_dir/*.c 2> /dev/null); do
			...
			touch $log
			cp $file "$home/b747cl_grt_rtw/b747cl.c"
...
cp "$home/b747cl.c" "$home/b747cl_grt_rtw/b747cl.c"
echo "----------------------------------------"
