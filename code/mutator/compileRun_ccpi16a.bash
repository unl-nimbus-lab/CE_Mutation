...
compile_command="make -f ccpi16a.mk"
...
cp "$home/ccpi16a_grt_rtw/ccpi16a.c"  "$home/ccpi16a.c"
...
do
	...
	for filename in $(find /$full_path_dir/*.c 2> /dev/null); do
			...
			touch $log
			cp $file "$home/ccpi16a_grt_rtw/ccpi16a.c"
...
#cp "$home/ccp2016a.c" "$home/b747cl_grt_rtw/ccp2016a.c"
cp "$home/ccpi16a.c" "$home/ccpi16a_grt_rtw/ccpi16a.c"
echo "----------------------------------------"
