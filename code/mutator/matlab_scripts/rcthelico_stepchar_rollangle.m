...
chfl='/home/balaji/clang-llvm/mutationdocker/code/mutants_rct_helico';
...
load('/home/balaji/clang-llvm/mutationdocker/code/mutants_rct_helico/helico_original.mat')
base_value= phi;
base_sti = stepinfo(phi,tout,1);
...
for folder_list = 3:numel(folder_names)
    mut_folder=strcat('/home/balaji/clang-llvm/mutationdocker/code/mutants_rct_helico/',folder_names(folder_list).name);
    ...
    home = '/home/balaji/clang-llvm/mutationdocker/code/mutants_rct_helico';
    cd(home)
...
%             step_charac_PeakTime(i)= -1000;
        ...
        file = [file_path '/rct_helico_' log_fileid{2} '.mat'];
        load(file)
        sti = stepinfo(rt_phi,rt_tout,1);
...
%         disp sti.SettlingMin
%         sti.SettlingMin
%         disp base_sti.SettlingMin
%         base_sti.SettlingMin
%         disp threshold_SettlingMin
%         threshold_SettlingMin
         %Determine live or dead mutants
%          sti.SettlingTime
%          base_sti.SettlingTime
%          threshold_SettlingTime
...
%         mutant_index
%         no_of_quantites_within_threshold
        mutantnumbervalue_quantites_within_threshold_(i)=no_of_quantites_within_threshold;
...
% Create figure
figure1 = figure('Name','Helicopter roll angle % Live mutants');
...
% Create figure
figure2 = figure('Name','Helicopter roll angle % Dead mutants');
...
%         fclose(fid);
%         
%         file = [file_path '/rct_helico_' int2str(i) '.mat'];
%         load(file)
%         sti = stepinfo(rt_phi,rt_tout,1);
%         
%         %increase mutant count
