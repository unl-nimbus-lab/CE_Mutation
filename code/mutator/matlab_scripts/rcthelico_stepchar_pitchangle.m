...
base_value= theta;
base_sti = stepinfo(theta,tout,1);
...
%             step_charac_PeakTime(i)= -1000;
        ...
        load(file)
        sti = stepinfo(rt_theta,rt_tout,1);
...
% Create figure
figure1 = figure('Name','Helicopter pitch angle % Live mutants');
...
% Create figure
figure2 = figure('Name','Helicopter pitch angle % Dead mutants');
