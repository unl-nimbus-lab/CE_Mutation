...
%for folder_names = {'00','02','03','04','05','08','10','11','14','30','32','33'}
% for folder_names = {'00','04'}
...
%         is_blow_up
        ...
        %if (abs(sti.RiseTime-base_sti.RiseTime) > threshold_RiseTime) || (abs(sti.SettlingTime-base_sti.SettlingTime) > threshold_SettlingTime) || (abs(sti.SettlingMin-base_sti.SettlingMin) > threshold_SettlingMin) || (abs(sti.SettlingMax-base_sti.SettlingMax) > threshold_SettlingMax) || ( sti.Overshoot > (base_sti.Overshoot + threshold_Overshoot) ) || ( sti.Undershoot > (base_sti.Undershoot + threshold_Undershoot)  ) || (abs(sti.Peak-base_sti.Peak) > threshold_Peak) || (abs(sti.PeakTime-base_sti.PeakTime) > threshold_PeakTime)
...
figure1 = figure('Name','CruiseControl speed % Live mutants');
%h = heatmap(xvalues,yvalues,(xdatalive'./overalltotalmutants)*100);
...
% Create figure
figure2 = figure('Name','CruiseControl speed % Dead mutants');
%h = heatmap(xvalues,yvalues,(xdatadead'./overalltotalmutants)*100);
...
% mut_folder='/home/balaji/clang-llvm/cppdocker/code/mutator/mutants';
...
% format long;
% %load base values to compare with
% load('/home/balaji/clang-llvm/cppdocker/code/mutator/base_original.mat')
% base_value = tout(2,:);
% 
% 
% running_mutants_per_order = [];
...
%                
%         %Generate right file paths
%         %file_path="/home/balaji/clang-llvm/cppdocker/code/mutator/mutants";
...
%         fclose(fid);
%         
%         file = [file_path '/ccpi16a_' int2str(i) '.mat'];
%         load(file)
%         sti = stepinfo(tout(2,:),tout(1,:),10);
%         
%         %increase mutant count
